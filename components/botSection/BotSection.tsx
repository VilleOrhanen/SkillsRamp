...
const BotSection = (props: IBot) => {
    ...
    return(
      <div className="mx-48 flex min-h-screen flex-col py-2 md:mx-26">
          <div className="grid grid-flow-row auto-rows-max gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
              {/* main content */}
              <main className="mt-28 max-w-3xl md:max-h-[85vh]">
                  <div>
                      <h1 className="text-4xl font-bold text-black">{heading}</h1>
                      <Image {...image} className="mt-8 max-w-lg mb-8" />
              ...
              <aside className="mt-8 max-w-4xl overflow-auto rounded-lg bg-white shadow-2xl md:max-h-[85vh] md:min-h-[800px] md:p-8">
